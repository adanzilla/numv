...
function initMap() {
	...
	if( jQuery('#map').length ){
		...
		var center = googlemap_data.center_map;
		...
		const map = new google.maps.Map(document.getElementById("map"), {
			//zoom: 9,
			zoom: parseInt( googlemap_data.zoom ),
			center: center,
			...
			if( location.latitud != 0 ){
				...
				const contentString = '<div class="row no-gutters info-window">'+
									    '<div class="col-12">'+
									        ...
									        '<p><span style="font-weight: 600;">Usuario:</span> '+ location['usuario'] +'</p>'+
									        '<p><span style="font-weight: 600;">Sexo:</span> '+ location['genero'] +'</p>'+
									        '<p><span style="font-weight: 600;">Edad:</span> '+ location['edad'] +' años</p>'+
									        '<p><span style="font-weight: 600;">Vehículo:</span> '+ location['vehiculo'] +'</p>'+
									        '<hr>'+
